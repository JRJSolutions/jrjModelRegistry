...
from jrjModelRegistry.jrjModelRegistry import loadAJrjModel, registerAJrjModel
...
def test_newRegisterModel006():
    ...
    models = search_models_common({
        "search": {
            "where": {
                "modelName": "test_newRegisterModel006",
            },
            "orderBy":  [
                {
                    "modelName": "desc"
    ...
    config_body = {
        # "modelName":f"test_newRegisterModel006",
        # "version":"1",
        "modelType": "data",
        "score": 1,
        "helpers":{},
    ...
    config_body['modelName'] = f"test_newRegisterModel006"
    ...
    print(model_metadata)
    modelxx = loadAJrjModel(model_metadata)

    print(modelxx.mainPredictor('xxxxxxx'))
    ...
    requestSearch = client.post(
        ...
        json={
            ...
            "data": {"test": "testXXXCXXCvvddfdfFGBHG"}
        },
    )
    result = requestSearch.json()
    print(result)
